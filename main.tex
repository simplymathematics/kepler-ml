...
\begin{figure*}[h!]
    ...
    \begin{subfigure}[b]{\linewidth}
        ...
        \caption{}
    \end{subfigure}
    \caption{The training rate and survival heuristic that depicts the per-sample ratio of training time to attack time. If this value is greater than one (the red line), then the model can be discarded as ineffective.}
    \label{fig:trash}
\end{figure*}
