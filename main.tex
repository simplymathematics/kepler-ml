...
\begin{figure}
  \centering
  % include second image
  \includegraphics[width=0.8\linewidth,trim={20pt 20pt 20pt 20pt},clip]{plots/combined/log_logistic_accuracy_partial_effect.pdf} 
...
\begin{figure}
  \centering
  % include second image
  \includegraphics[width=0.8\linewidth,trim={20pt 20pt 20pt 20pt},clip]{plots/combined/log_logistic_adv_failure_rate_partial_effect.pdf} 
