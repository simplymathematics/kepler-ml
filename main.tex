...
$$
    \phi_{\theta}(x) = \exp( \theta_0 \varepsilon + \theta_1 x_1 + \cdots + \theta_n x_n),
$$
\cm{
and where $\varepsilon, x$ are covariates and $\theta_0, \ldots, \theta_n$ describe the fitted parameters.
}
...
\begin{equation}    
t_{a} = \mathbb{E}_{S_\theta}[T] = \int_0^{t^*}  S_\theta(t) \,dt 
