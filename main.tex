...
\begin{figure}[h!]
    ...
    \begin{subfigure}[b]{\linewidth}
        ...
        \caption{Plot depicting the relationship between the modelled number of failures (x-axis) and the measured number of failures (y-axis).}
    \end{subfigure}
    \begin{subfigure}[b]{\linewidth}
        \centering
    ...
    \begin{subfigure}[b]{\linewidth}
        \centering
        \includegraphics[width=.7\linewidth,clip]{plots/combined/log_logistic_attack_eps_partial_effect.pdf}
