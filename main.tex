...
\begin{figure*}[h!]
    ...
    %     \centering
    %     \includegraphics[width=\linewidth]{plots/combined/weibull_device_num_partial_effect.pdf}
    %     \caption{\cm{The partial effect GPU on survival time. After accounting for GPU bandwidth (see Table~\ref{tab:hardware}) and the covariate effects of the hardware and and inference time, we se ethat Graphic}}
    %     \label{fig:partial_effect}
    % \end{subfigure}
