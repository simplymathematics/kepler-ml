...
\cm{In this paper, we use survival analysis to present a time-efficient and formal method for predicting model performance in the presence of adversarial noise.}
...
% \[
%     \textrm{Marginal~Risk} := \frac{ \Delta S(t)}{\Delta C_a},
% \]
...
This section outlines specific implementation details for the evaluation of the methodology outlined in Sec.~\ref{afr}.
...
\begin{figure*}[h]
    ...
    \begin{subfigure}[b]{.8\textwidth}
        ...
        \label{fig:cost}
    \end{subfigure}
    \caption{The run-times, power consumption, and monetary cost of training, prediction, and attack generation across all hardwware and datasets.}
\end{figure*}
...
\begin{figure}[h!]
    ...
    \begin{subfigure}[b]{\linewidth}
        ...
        \caption{Plot depicting the relationship between the modelled number of failures (x-axis) and the measured number of failures (y-axis). The dotted line depicts a perfect model.}
        \label{fig:qq}
    \end{subfigure}
    \begin{subfigure}[b]{\linewidth}
        \centering
        \includegraphics[width=.7\linewidth,clip]{plots/combined/log_logistic_aft.pdf}
        \caption{Coefficients of the Covariates for the Log Logistic AFR model}
        \label{fig:aft}
    \end{subfigure}
    \begin{subfigure}[b]{\linewidth}
        \centering
        \includegraphics[width=.7\linewidth,clip]{plots/combined/log_logistic_device_num_partial_effect.pdf}
